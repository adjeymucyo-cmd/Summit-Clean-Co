...
const fallbackServices: ServiceRow[] = [
  ...
  },
  {
    ...
    short_description: 'Reliable janitorial care for offices, storefronts, and shared spaces.',
    description: 'Help your workplace stay welcoming, safe, and polished with professional commercial cleaning.',
    image_url: 'https://images.unsplash.com/photo-1556761175-4b46a57231d4?auto=format&fit=crop&w=900&q=80',
    display_order: 2,
    is_active: true,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
