...
export default function QuotePage() {
  return (
    <main className="bg-[#e8fbf0] min-h-screen w-full px-0 py-6 sm:px-6 lg:px-8 sm:py-20">
      <div className="mx-auto w-full max-w-3xl rounded-none sm:rounded-2xl md:rounded-[2rem] border-t border-b sm:border border-[#bce2d5] bg-white p-4 sm:p-8 md:p-10 shadow-none sm:shadow-[0_20px_50px_rgba(31,119,104,0.08)]">
        ...
        <div className="mt-4 sm:mt-10">
          <AnimatedSection>
            <div className="rounded-none sm:rounded-2xl md:rounded-[2rem] border-t border-b sm:border border-[#DCE5E1] bg-transparent sm:bg-white p-0 sm:p-6 md:p-8 shadow-none sm:shadow-sm">
              <QuoteForm />
            </div>
          </AnimatedSection>
        </div>
